...
echo $i" |"$pu" Contack WhatsApp :"$ku"  01996584456"$i"             |"
echo $i" |"$pu" Contack Gmail :"$ku"    mda720078@gmail.com"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
...
sleep 2
echo $ku"WhatsApp :"$i" 01996584456"
echo $ku"Facebook :"$i"  MD Ali    "
sleep 2
echo $pur">> thank for support me <<"
exit
fi
